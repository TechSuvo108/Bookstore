...
const Footer = () => {
    ...
    return (
        <>
            <footer className="footer footer-horizontal footer-center text-base-content rounded p-10 bg-base-200">
                ...
                <nav className="grid grid-flow-col gap-4">
                    ...
                    <button
                        ...
                        data-tip="Your data is safe with us 🔒"
                    >
                        Privacy
                    </button>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        <button onClick={handleSocialClick}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" className="fill-current hover:text-pink-500 transition">
                                ...
                                -.247-2.229-.616-.054 2.281 1.581 4.415 3.949
                                4.89-.693.188-1.452.232-2.224.084.626
                                1.956 2.444 3.379 4.6 3.419-2.07
                                1.623-4.678 2.348-7.29 2.04 2.179
                                1.397 4.768 2.212 7.548 2.212 9.142
                        ...
                        <button onClick={handleSocialClick}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                11.626.246 15.23 0 3.897-.266 4.356
                                -2.62 4.385-8.816-.029-6.185-.484
                                -8.549-4.385-8.816zm-10.615
                        ...
                        <button onClick={handleSocialClick}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                .358-4h-4v-1.667c0-.955.192
                                -1.333 1.115-1.333h2.885v
                                -5h-3.808c-3.596 0-5.192
